#+TITLE: Introduction to Programming - Printing values
#+AUTHOR: Marcus Birkenkrahe
#+SUBTITLE: CSC 100 - Lyon College - Spring 2025
#+SEQ_TODO: PRACTICE TODO NEXT CODEALONG | DONE
...
* CODEALONG Printing requires format
...
* CODEALONG Printing over multiple lines
