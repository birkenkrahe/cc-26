...
- *Practice exercises* (in-class):
  ...
  4. [X] Writing, compiling and executing in OneCompiler.com.
...
* NEXT Interpretation vs. Compilation
...
- Check out this nice demo video (1983, [[https://chat.google.com/room/AAAAIk8SqZE/RRaBeQiix8U/RRaBeQiix8U?cls=10][shared via Chat]])
  #+attr_html: :width 300px:
...
* PRACTICE The first program (Demo with Cloud shell + nano)
...
(IDE). *If you're swift, you can code along with me.*

1) Problem: Print the message =Hello, world!= to the screen.

2) Open [[https://ide.cloud.google.com][Google Cloud Shell]], & enter =nano= at the prompt.
...
9) Make a screenshot of your terminal and submit it to Canvas
   ([[https://lyon.instructure.com/courses/4410/assignments/58081]["In-class practice 3: Hello World in Google Cloud Shell"]])
...
* DONE C Programming with OneCompiler
** Objective
