...
#+SUBTITLE: CSC 100  - Lyon College - Spring 2026
...
- Simple sequential (or serial) ~if~ statements:
  #+begin_example C
  if ( i == 1 ) {
     // do one thing
  }
...
- An illustration in BPMN (Business Process Model and Notation):
  #+name: fig:singleif
...
- Source code: Run this in https://tinyurl.com/pseudo-health-example
  #+begin_src C
...
- *Sample pseudocode solution:* [[https://tinyurl.com/loot-difficulty-starter][tinyurl.com/loot-difficulty-starter]]
...
- *Sample source code solution:* 

  [[https://tinyurl.com/loot-difficulty-solution][tinyurl.com/loot-difficulty-solution]]
...
- Source code: Run this in

  [[https://tinyurl.com/wounded-but-alive][tinyurl.com/wounded-but-alive]]
