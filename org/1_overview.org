...
- The first assignment is to read the first chapter, "The Way of the
  ...
  exercises. You don't have to do the exercises! *BY MONDAY 19-JAN*.
...
- There will be 10 of these 30-50 multiple-choice home tests in the
  term, and number of surprise pop-quizzes to solve in class.
