...
#+SUBTITLE:Syllabus - CSC 100.01 - Lyon College - Spring 2026
...
- Course prefix/number/section: CSC 100.01
...
This course is listed in the core curriculum as problem solving (PS).

One of the grading categories and programming, will be evaluated using
a rubric.
...
I will give you examples for deliverables that "exceed expectations"
as the rubric calls it when the time comes.

Link to the rubric: [[https://tinyurl.com/problem-solving-rubric][tinyurl.com/problem-solving-rubric]]
