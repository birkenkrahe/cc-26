...
- This script introduces C looping structures with ~do~ and ~while~.
...
- Starter code: [[https://tinyurl.com/pseudo-do-while][tinyurl.com/pseudo-do-while]]
...
- Code solution:   [[https://onecompiler.com/c/]]
