...
- Pseudo code: see [[https://tinyurl.com/hello-polite][tinyurl.com/hello-polite]] to code along.
  #+begin_example C
  // declare function
  // void hi2 (string)
...
- How many functions do you see in the following code block and what
  do you think will be its output?
...
- Let's put it into a program & code along:
  [[https://tinyurl.com/function-average][tinyurl.com/function-average]]
  #+name: onecompiler.com/c/43ennnadq
  ...
  #+RESULTS: onecompiler.com/c/43ennnadq
...
1. Write a function =print_value= that
   - returns ~void~
   - has one ~int~ argument
   - prints its ~int~ argument

2. Declare the function before ~main~

3. Define the function after ~main~

4. Call the function in ~main~ on the value =100=
...
#+begin_src C :main no :includes :results output :exports both
  ...
  // function prototype: print_value
  ...
  // function definition: print_value
...
* Extension: Printing an array with a function

- To print an array, you need to pass two things to the function:
  1. The array's name followed by =[]=
  2. The length of the array (as an ~int~)
  3. You can compute the length of an array:
     #+begin_example C
     sizeof(array)/sizeof(array[0])
     #+end_example

- Let's code this together: Open a new file.

- Version 1: With set array length
  #+begin_src C :main no :includes :results output :exports both 
    #include <stdio.h>
    #define SIZE 5 // SET array length

    // function prototype: print_array
    ...
    int main(void)
    {
      ...
      // call print_array function to print array
...
- Version 2: Compute array length
  #+begin_src C :main no :includes :results output :exports both 
    #include <stdio.h>
...
- Pseudocode: [[https://onecompiler.com/c/43enqjaku][onecompiler.com/c/43enqjaku]] - Complete the code!
  ...
  https://tinyurl.com/average-two-double
...
- Here is some starter code ([[https://onecompiler.com/c/43enrrj7p][onecompiler.com/c/43enrrj7p]])
  ...
  https://tinyurl.com/add-three-int
...
- *Starter code*: [[https://onecompiler.com/c/43ent6a2m][onecompiler.com/c/43ent6a2m]]
  ...
  https://tinyurl.com/return-larger-int
...
- *Goal:* Write a function =sum_array= that accepts an array of integers
  and its length, and returns the sum of all elements.

- *Tip 1*: To pass an array to a function =f=, use the arguments =f(int a,
  int n)= where =a= is the array, and =n= is the array's size or length.
...
- *Steps:*
  1. Write the function prototype for ~sum_array~.
  2. In ~main~, define an integer array and compute its length using
     ~sizeof(arr)/sizeof(arr[0])~.
  3. Call ~sum_array~ with the array and its length, and store the result.
  4. Print the result in ~main~.
  5. Define the ~sum_array~ function using a loop to compute the sum.

- *Tip 2:* In =sum_array=, use a variable like ~sum~ initialized to 0, and
  add each array element inside a ~for~ loop.

- *Starter code*: [[https://tinyurl.com/sum-array][tinyurl.com/sum-array]]
